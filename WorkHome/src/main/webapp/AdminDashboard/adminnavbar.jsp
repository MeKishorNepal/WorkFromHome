    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="adminDashboard.jsp">Dashboard</a></li>
                <li class="nav-item"><a class="nav-link" href="Create_task.jsp"> Create Task</a></li>
                <li class="nav-item"><a class="nav-link" href="manage_task.jsp">Manage Task</a></li>
                <li class="nav-item"><a class="nav-link" href="application.jsp">Leave Application</a></li>
                </ul>
		...
		<% }
			...
			{%>
				...
				<button style="margin-right: 20px;" class="user"><%=a.getName()%></button>
